/*! jQuery v3.3.1 -ajax,-ajax/jsonp,-ajax/load,-ajax/parseXML,-ajax/script,-ajax/var/location,-ajax/var/nonce,-ajax/var/rquery,-ajax/xhr,-manipulation/_evalUrl,-event/ajax,-effects,-effects/Tween,-effects/animatedSelector | (c) JS Foundation and other contributors | jquery.org/license */ !(function(e, t) {
            ...
            return a !== p && 9 === a.nodeType && a.documentElement ?
                ((p = a),
                    ...
                    (n.getById = se(function(e) {
                        return (
                            (h.appendChild(e).id = x), !p.getElementsByName ||
    ...
    w.fn.extend({
        ...
        is: function(e) {
            return !!L(
                this,
                "string" == typeof e && A.test(e) ? w(e) : e || [], !1
            ).length;
        }
    });
    var j,
                ...
                if (
                    ((t = t instanceof w ? t[0] : t),
                        w.merge(
                            ...
                            w.parseHTML(
                                i[1],
                                t && t.nodeType ? t.ownerDocument || t : r, !0
                            )
                        ),
    ...
    function Re(e, t, n, r) {
        ...
        if (
            ...
            if (s)
                for (
                    c = u[u.length - 1].ownerDocument, w.map(u, Pe), f = 0; f < s; f++
                )
                    (l = u[f]),
                    he.test(l.type || "") &&
    ...
    w.extend({
            ...
            clone: function(e, t, n) {
                ...
                if (t)
                    if (n)
                        for (
                            o = o || ve(e), a = a || ve(u), r = 0, i = o.length; r < i; r++
                        )
                            He(o[r], a[r]);
                    else He(e, u);
                return (
